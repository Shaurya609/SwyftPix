...
const styles = StyleSheet.create({
  card: { borderRadius: 24, overflow: 'hidden', height: '100%', width: '100%', shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.15, shadowRadius: 10, elevation: 6 },
  cardLight: { backgroundColor: '#FFFFFF', shadowColor: '#000000', borderWidth: 1, borderColor: '#E5E5EA' },
  cardDark: { backgroundColor: '#1C1C1E', shadowColor: '#000000', borderWidth: 1, borderColor: '#2C2C2E' },
  ...
  audioHint: { flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 12, paddingVertical: 6, borderRadius: 14, backgroundColor: 'rgba(108, 92, 231, 0.1)' },
  audioHintText: { color: '#6C5CE7', fontSize: 11, fontWeight: '700' },
  videoOverlay: { ...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(0, 0, 0, 0.15)', justifyContent: 'center', alignItems: 'center' },
  playButton: { width: 64, height: 64, borderRadius: 32, backgroundColor: 'rgba(0, 0, 0, 0.5)', justifyContent: 'center', alignItems: 'center', borderWidth: 2, borderColor: '#FFFFFF' },
  durationBadge: { position: 'absolute', bottom: 12, right: 12, backgroundColor: 'rgba(0, 0, 0, 0.75)', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 6 },
  durationText: { color: '#FFFFFF', fontSize: 11, fontWeight: '600' },
  sourceBadge: { position: 'absolute', top: 14, left: 14, paddingHorizontal: 12, paddingVertical: 6, borderRadius: 12, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.15, shadowRadius: 3, elevation: 2 },
  sourceText: { color: '#FFFFFF', fontSize: 12, fontWeight: '700', textTransform: 'uppercase' },
  typeOverlay: { position: 'absolute', top: 14, right: 14, width: 32, height: 32, borderRadius: 16, justifyContent: 'center', alignItems: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.15, shadowRadius: 3, elevation: 2 },
  typeOverlayLight: { backgroundColor: 'rgba(255, 255, 255, 0.9)' },
  typeOverlayDark: { backgroundColor: 'rgba(28, 28, 30, 0.9)' },
  infoContainer: { paddingHorizontal: 18, paddingVertical: 16 },
  nameRow: { marginBottom: 10 },
  fileName: { fontSize: 16, fontWeight: '700' },
  metaGrid: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 4 },
  metaColumn: { flex: 1 },
  metaLabel: { fontSize: 10, fontWeight: '600', letterSpacing: 1.2, marginBottom: 4 },
  labelLight: { color: '#8E8E93' },
  labelDark: { color: '#636366' },
  metaValue: { fontSize: 14, fontWeight: '600' },
  divider: { width: 1, height: 28, marginHorizontal: 16 },
  inspectPrompt: { position: 'absolute', bottom: 12, alignSelf: 'center', flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: 'rgba(0, 0, 0, 0.65)', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 14, zIndex: 20 },
  inspectText: { color: '#FFFFFF', fontSize: 11, fontWeight: '600' },
});